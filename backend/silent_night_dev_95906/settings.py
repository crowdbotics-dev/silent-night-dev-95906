"""
Django settings for silent_night_dev_95906 project.
...
ROOT_URLCONF = 'silent_night_dev_95906.urls'
...
WSGI_APPLICATION = 'silent_night_dev_95906.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_night_dev_95906 API",
    "DESCRIPTION": "API documentation for silent_night_dev_95906 App",
    "VERSION": "v1",
}
